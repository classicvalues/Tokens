...
CHARSET = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'  # Replace this with the character set for each language
MIN_TOKEN_LENGTH = 1
MAX_TOKEN_LENGTH = 4
...
def write_tokens_to_csv(tokens, max_columns, output_dir='C:\\Artificial_Intelligence\\Tokens\\English_Tokens'):
